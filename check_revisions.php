...
while($row = $res->fetch_assoc()) {
    ...
    // Check for srviisbog17 in this revision
    if (strpos($row['post_content'], 'srviisbog17') !== false) {
        echo "Found srviisbog17 in this revision.\n";
        // Show some context
        ...
        echo "No srviisbog17 found in this revision.\n";
    }
    echo "-------------------\n";
}
