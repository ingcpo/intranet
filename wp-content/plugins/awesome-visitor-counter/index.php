        ...
        ?>
         <div class="row">
          <div class="col-md-3 col-3 text-center">
              <div class="wp-block-kioken-countup text-align-none kt-countup__91ac91-5e animated" data-object-id="_91ac91-5e" data-count-from="0"><div class="counter-wrap kt_d_flex"><span class="kt-count cifra"><span class="cifra"><?php echo vcp_get_visit_count('D') ?></span></span></div></div>
              <p class="text-center gris mb-0">Visitas</p>
              <p class="gris"><strong>HOY</strong></p>
          </div>
          
          <div class="col-md-3 col-3 text-center">
             <div class="wp-block-kioken-countup text-align-none kt-countup__0775d5-25 animated" data-object-id="_0775d5-25" data-count-from="0"><div class="counter-wrap kt_d_flex"><span class="kt-count cifra">
              <span class="cifra"><?php echo vcp_get_visit_count('W') ?></span></span></div></div>
              <p class="text-center gris mb-0">Última</p>
              <p class="gris"><strong>SEMANA</strong></p>
          </div>
          
          <div class="col-md-3 col-3 text-center">
             <div class="wp-block-kioken-countup text-align-none kt-countup__18cc28-e6 animated" data-object-id="_18cc28-e6" data-count-from="0"><div class="counter-wrap kt_d_flex"><span class="kt-count cifra">
              <span class="cifra"><?php echo vcp_get_visit_count('M') ?></span></span></div></div>
              <p class="text-center gris mb-0">Último</p>
              <p class="gris"><strong>MES</strong></p>
          </div>
          
          <div class="col-md-3 col-3 text-center">
             <div class="wp-block-kioken-countup text-align-none kt-countup__33a44d-9d animated" data-object-id="_33a44d-9d" data-count-from="0"><div class="counter-wrap kt_d_flex"><span class="kt-count cifra">
              <span class="cifra"><?php echo vcp_get_visit_count('T') ?></span></span></div></div>
              <p class="text-center gris mb-0">Visitas</p>
              <p class="gris"><strong>TOTALES</strong></p>
          </div>
