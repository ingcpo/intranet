...
<section class="no-results not-found pb-3">

	<header class="page-header">

		<h1 class="page-title text-center azul"><?php esc_html_e( 'Nothing Found', 'understrap' ); ?></h1>
	...
	<div class="page-content">
		...
		if ( is_home() && current_user_can( 'publish_posts' ) ) :
			...
			printf(
				...
				'<p class="text-center">' . wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'understrap' ), $kses ) . '</p>',
